        ...
        <MainContainer>
          <MainContent>
            ...
            <FormContainer>
              ...
              <div class="radio" >
                <input class="input" onclick ={()=>{showStat1 =!showStat1;}} type="radio" value="Etudiant" name="gender" /> Etudiant
                <input class="input" type="radio" value="Doctor" name="gender" /> Doctor
              </div>
              {showStat1 && <Input type="text" placeholder="Nom de university" />}
                
              {showStat2 && <Input type="text" placeholder="Nom de clinique" />}
